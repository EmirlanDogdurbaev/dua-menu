...
const CategorySlider = ({categories, selectedCategory, onSelectCategory}) => (<div className={classes.category_slider}>
    <Swiper
        slidesPerView="auto"
        spaceBetween={15}
        navigation={{
            nextEl: '.swiper-button-next-categories', prevEl: '.swiper-button-prev-categories',
        }}
        modules={[Navigation]}
